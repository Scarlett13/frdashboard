...
type DropzoneInputProps = {
  ...
  setImageSource?: Dispatch<SetStateAction<string | null>> | null;
};
...
export default function DropzoneInput({
  ...
  const onDrop = React.useCallback(
    <T extends File>(acceptedFiles: T[], rejectedFiles: FileRejection[]) => {
      if (rejectedFiles && rejectedFiles.length > 0) {
        ...
        setImageSource && setImageSource(acceptedFilesPreview[0].preview);
    ...
    [clearErrors, files, id, maxFiles, setError, setValue, setImageSource]
  );
  ...
  const deleteFile = (
    ...
    if (newFiles.length > 0) {
      ...
      setImageSource && setImageSource(null);
      setFiles([]);
